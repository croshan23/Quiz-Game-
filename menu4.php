...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Menu 4" />
...
<!--*************ARTICLE***************-->  
    ...
    <!--************* article ***************-->
        ...
        <h2>Menu 4 -> List all students (id, first and last name) got less than 50% on their third attempt.</h2>
        <?php
            ...
            $sql = "SELECT student_id, firstname, lastname FROM attempts WHERE no_of_attempts='3' AND score<'2'";
